...
#define TESTUTIL_BASE 0x90000000
#define TESTUTIL_ADDR_HALT (TESTUTIL_BASE + 0x960)
#define TESTUTIL_ADDR_BEGIN_SIGNATURE (TESTUTIL_BASE + 0x968)
#define TESTUTIL_ADDR_END_SIGNATURE (TESTUTIL_BASE + 0x96C)
